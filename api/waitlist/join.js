  ...
  try {
    ...
    await sendEmail({
      ...
      html: `
        ...
        <div style="margin:0;padding:24px;background:#05070D;">
          <div style="font-family:Inter,Arial,sans-serif;max-width:620px;margin:0 auto;background:#0C0C12;border:1px solid rgba(255,255,255,0.10);border-radius:14px;overflow:hidden;box-shadow:0 20px 45px rgba(0,0,0,0.45);">
            <div style="padding:20px 24px;background:linear-gradient(135deg,#0A0A0C,#11192A);background-color:#0A0A0C;color:#FFFFFF;border-bottom:1px solid rgba(255,255,255,0.10);">
            ...
            <div style="padding:24px;color:#E9EEF9;">
              <p style="margin:0 0 12px;font-size:16px;line-height:1.55;color:#E9EEF9;">Thanks for joining the Cognetra Founder's Circle waitlist.</p>
              <p style="margin:0 0 16px;font-size:16px;line-height:1.55;color:#E9EEF9;">Please confirm your email to activate launch updates and early access notices.</p>
              ...
              <div style="margin:0 0 16px;padding:14px;border:1px solid rgba(124,108,248,0.35);border-radius:10px;background:#12121A;">
                <div style="font-size:12px;font-weight:700;letter-spacing:0.06em;color:#BFC9E4;text-transform:uppercase;margin-bottom:8px;">What to expect</div>
                <ul style="padding-left:18px;margin:0;color:#CED7EA;font-size:13px;line-height:1.7;">
              ...
              <p style="margin:0 0 8px;font-size:14px;line-height:1.6;color:#A5B0C8;">This secure link expires in 48 hours.</p>
              <p style="margin:0 0 8px;font-size:14px;line-height:1.6;color:#A5B0C8;">No marketing blasts. Only launch and access updates.</p>
              <p style="margin:0 0 12px;font-size:14px;line-height:1.6;color:#A5B0C8;">If you did not request this, you can safely ignore this email.</p>
              <p style="margin:0;">
                <a href="${unsubscribeUrl}" style="display:inline-block;min-height:44px;padding:12px 14px;background:rgba(92,107,192,0.14);color:#C8D2F0;text-decoration:none;border:1px solid rgba(92,107,192,0.45);border-radius:999px;font-weight:600;font-size:13px;line-height:1.2;">Unsubscribe</a>
              </p>
            </div>
