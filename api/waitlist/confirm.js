          ...
          <div style="margin:0;padding:24px;background:#05070D;">
            <div style="font-family:Inter,Arial,sans-serif;max-width:620px;margin:0 auto;background:#0C0C12;border:1px solid rgba(255,255,255,0.10);border-radius:14px;overflow:hidden;box-shadow:0 20px 45px rgba(0,0,0,0.45);">
              ...
              <div style="padding:24px;color:#E9EEF9;">
                <p style="margin:0 0 12px;font-size:16px;line-height:1.55;color:#E9EEF9;">Your email is confirmed for Cognetra launch updates and early access announcements.</p>
                <p style="margin:0 0 16px;font-size:16px;line-height:1.55;color:#E9EEF9;">Thank you for joining the Founder's Circle waitlist.</p>
                <div style="margin:0 0 16px;padding:14px;border:1px solid rgba(124,108,248,0.35);border-radius:10px;background:#12121A;">
                  <div style="font-size:12px;font-weight:700;letter-spacing:0.06em;color:#BFC9E4;text-transform:uppercase;margin-bottom:8px;">Early launch benefits</div>
                ...
                <p style="margin:0 0 10px;font-size:14px;line-height:1.6;color:#A5B0C8;">Typical update cadence: 1-2 emails/month until launch.</p>
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 0 12px;">
                  <tr>
                    <td bgcolor="#5C6BC0" style="border-radius:999px;mso-padding-alt:13px 18px 13px 18px;">
